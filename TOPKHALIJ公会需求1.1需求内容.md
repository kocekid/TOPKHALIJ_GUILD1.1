# TOPKHALIJ 公会需求 1.1：公会薪资字段隐藏、主播比例输入调整、退出公会申请管理、公会资料编辑、后台新增公会表单与申请站内信

## 一、版本目标与范围

本文仅描述 1.1 相对《TALO公会政策_客户端后台需求文档PRD》1.0 的调整：薪资展示字段隐藏、普通政策主播比例输入校验、主播退出公会申请及公会长处理申请、公会资料编辑，以及后台新增公会表单调整和加入/退出公会申请站内信。未明确变更的页面、字段、交互、结算、预支、余额、提现、历史快照和离会规则均沿用 1.0。

| 项目 | 说明 |
|---|---|
| 需求版本 | 1.1 |
| 调整主题 | 隐藏薪资页面中原型圈选且标记“隐藏”的字段；调整普通政策主播比例输入逻辑；新增主播退出申请处理、公会资料编辑、后台新增公会表单调整及加入/退出公会申请站内信 |
| 涉及角色 | 公会长、主播、后台运营 |
| 涉及范围 | 当前薪资数据页、历史明细页、普通政策比例设置弹窗、主播退出公会申请弹窗、公会长主播退出申请列表及其公会资料编辑入口、后台新增公会弹窗、加入/退出公会申请相关站内信 |
| 原型依据 | 当前版本用户提供的 1.1 原型图 |
| 非本次范围 | 未圈选字段、未标记调整的页面逻辑、日期选择、提现流程及既有结算规则；除第十一章列明的申请站内信外，不扩写原型未展示的审核确认弹窗、离会原因、撤回申请或其他通知规则，也不改写既有离会结算规则 |
...
| 17 | 加入/退出公会申请 | 站内信 | 申请提交、同意、拒绝、自动拒绝的中英阿消息模板 | 新增消息文案 |
...
本模块仅新增主播端退出公会申请：提交后等待所属公会长处理，超时未处理自动拒绝。离会原因、撤回、违约金、结算金额展示、提现限制均不在本次范围；公会长审核见第九章，申请站内信见第十一章，申请通过后的离会结算、预支抵扣、归属解除、余额、快照和冷却期沿用 1.0。
...
公会长通过“主播申请 > 退出”查看本公会主播退出申请，并对待处理申请执行“同意”或“拒绝”。本次仅定义原型展示的页面、字段、状态、倒计时和处理动作；站内信模板见第十一章；不新增审核确认弹窗、审核原因、批量处理、撤回或处理后编辑。
...
本章仅定义主播加入/退出公会申请的站内信标题与正文。申请成功提交时通知对应公会长；申请同意、拒绝或倒计时结束自动拒绝时通知主播。退出申请“已通过”消息仅在主播已成功退出公会后发送。

### 11.2 中英阿消息模板

| 场景 | 接收人 | 触发时机 | 中文标题 | 中文正文 | English Title | English Body | عنوان بالعربية | النص بالعربية |
|---|---|---|---|---|---|---|---|---|
| 主播发起加入公会申请 | 公会长 | 主播成功提交加入申请，状态进入待处理 | 新的加入公会申请 | 主播 {主播昵称}（ID：{主播ID}）申请加入公会 {公会名称}，请前往「主播申请 > 加入」处理。 | New Guild Join Request | Host {主播昵称} (ID: {主播ID}) has requested to join your guild, {公会名称}. Please go to “Host Applications > Join” to review it. | طلب جديد للانضمام إلى النقابة | تقدّم المضيف {主播昵称} (المعرّف: {主播ID}) بطلب للانضمام إلى نقابتك «{公会名称}». يُرجى الانتقال إلى «طلبات المضيفين > الانضمام» لمعالجة الطلب. |
| 主播发起退出公会申请 | 公会长 | 主播成功提交退出申请，状态进入待处理 | 新的退出公会申请 | 主播 {主播昵称}（ID：{主播ID}）申请退出公会 {公会名称}，请前往「主播申请 > 退出」处理。 | New Guild Exit Request | Host {主播昵称} (ID: {主播ID}) has requested to leave your guild, {公会名称}. Please go to “Host Applications > Exit” to review it. | طلب جديد لمغادرة النقابة | تقدّم المضيف {主播昵称} (المعرّف: {主播ID}) بطلب لمغادرة نقابتك «{公会名称}». يُرجى الانتقال إلى «طلبات المضيفين > المغادرة» لمعالجة الطلب. |
| 公会长同意主播加入 | 主播 | 公会长同意加入申请，主播成功加入公会 | 加入公会申请已通过 | 你申请加入公会 {公会名称} 的申请已通过，已成功加入该公会。 | Guild Join Request Approved | Your request to join {公会名称} has been approved. You have successfully joined the guild. | تمت الموافقة على طلب الانضمام إلى النقابة | تمت الموافقة على طلبك للانضمام إلى النقابة «{公会名称}». لقد انضممت إلى النقابة بنجاح. |
| 公会长拒绝主播加入 | 主播 | 公会长拒绝加入申请 | 加入公会申请未通过 | 你申请加入公会 {公会名称} 的申请未通过，本次申请已结束。 | Guild Join Request Not Approved | Your request to join {公会名称} was not approved. This application has ended. | لم تتم الموافقة على طلب الانضمام إلى النقابة | لم تتم الموافقة على طلبك للانضمام إلى النقابة «{公会名称}». انتهى هذا الطلب. |
| 系统自动拒绝主播加入 | 主播 | 加入申请倒计时结束仍未被处理 | 加入公会申请已自动拒绝 | 你申请加入公会 {公会名称} 的申请在倒计时结束前未被处理，系统已自动拒绝本次申请。 | Guild Join Request Automatically Rejected | Your request to join {公会名称} was not processed before the countdown ended. The system has automatically rejected this application. | تم الرفض التلقائي لطلب الانضمام إلى النقابة | لم تتم معالجة طلبك للانضمام إلى النقابة «{公会名称}» قبل انتهاء العد التنازلي، لذلك رفض النظام الطلب تلقائيًا. |
| 公会长同意主播退出 | 主播 | 公会长同意退出申请，且主播已成功退出公会 | 退出公会申请已通过 | 你退出公会 {公会名称} 的申请已通过，已成功退出该公会。 | Guild Exit Request Approved | Your request to leave {公会名称} has been approved. You have successfully left the guild. | تمت الموافقة على طلب مغادرة النقابة | تمت الموافقة على طلبك لمغادرة النقابة «{公会名称}». لقد غادرت النقابة بنجاح. |
| 公会长拒绝主播退出 | 主播 | 公会长拒绝退出申请 | 退出公会申请未通过 | 你退出公会 {公会名称} 的申请未通过，你当前仍属于该公会。 | Guild Exit Request Not Approved | Your request to leave {公会名称} was not approved. You are still a member of this guild. | لم تتم الموافقة على طلب مغادرة النقابة | لم تتم الموافقة على طلبك لمغادرة النقابة «{公会名称}». ما زلت عضوًا في هذه النقابة. |
| 系统自动拒绝主播退出 | 主播 | 退出申请倒计时结束仍未被处理 | 退出公会申请已自动拒绝 | 你退出公会 {公会名称} 的申请在倒计时结束前未被处理，系统已自动拒绝本次申请；你当前仍属于该公会。 | Guild Exit Request Automatically Rejected | Your request to leave {公会名称} was not processed before the countdown ended. The system has automatically rejected this application. You are still a member of this guild. | تم الرفض التلقائي لطلب مغادرة النقابة | لم تتم معالجة طلبك لمغادرة النقابة «{公会名称}» قبل انتهاء العد التنازلي، لذلك رفض النظام الطلب تلقائيًا. ما زلت عضوًا في هذه النقابة. |
...
| {主播昵称} | 申请主播当前昵称。 |
| {主播ID} | 申请主播 ID。 |
| {公会名称} | 加入申请的目标公会名称，或退出申请时主播当前所属公会名称。 |
